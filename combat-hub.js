...
// v6.4.0-github — no Vercel dependency

(async()=>{
const VERSION='6.4.0-github';
...
const SNAPSHOT={
 ...
 boxing:{startAt:'2026-09-12T12:00:00-07:00',location:'ラスベガス',timeTba:true,main:{a:'ライアン・ガルシア',b:'コナー・ベン',context:'WBC ウェルター級タイトル戦'},support:[],source:'https://www.ringmagazine.com/news/ryan-garcia-vs-conor-benn-set-for-sept-12-in-las-vegas-2lAAiNVusWH1ZYNPUFQdQo'},
...
function dateText(d){if(D.timeTba)return`${dateOnly(d)} ・ 時刻未定`;const f=new DateFormatter();f.locale='ja_JP';f.timeZone='Asia/Tokyo';f.dateFormat="M/d (E) HH:mm 'JST'";return f.string(new Date(d));}
